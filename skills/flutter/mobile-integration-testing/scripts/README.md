...
### `validate_android_setup.sh` (Bash/Linux/macOS)

Script de validación para sistemas Unix (Linux, macOS) que verifica:
...
chmod +x validate_android_setup.sh

# Ejecutar
./validate_android_setup.sh
```
...
```
🔍 Validando configuración de Android SDK...

📦 Verificando variables de entorno Android...
✅ ANDROID_HOME está configurado: /Users/user/Library/Android/sdk

🔧 Verificando adb (Android Debug Bridge)...
✅ adb encontrado en PATH: /Users/user/Library/Android/sdk/platform-tools/adb
   Versión: Android Debug Bridge version 1.0.41

📱 Verificando emulator (Android Emulator)...
✅ emulator encontrado en PATH: /Users/user/Library/Android/sdk/emulator/emulator

📋 Verificando avdmanager (AVD Manager)...
✅ avdmanager encontrado: /Users/user/Library/Android/sdk/cmdline-tools/latest/bin/avdmanager
...
- name: Validate Android Setup
  run: |
    chmod +x scripts/validate_android_setup.sh
    ./scripts/validate_android_setup.sh
```
